const API_URL = "/api";
const DEFAULT_AVATAR = "https://via.placeholder.com/150?text=Profile";
const DEFAULT_POST_IMAGE = "https://via.placeholder.com/800x600?text=Image+Unavailable";
const DEFAULT_STORY_IMAGE = "https://via.placeholder.com/64?text=Story";
